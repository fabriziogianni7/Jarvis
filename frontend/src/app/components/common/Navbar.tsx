            ...
            <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                ...
                <div id="navbar-image-and-text-1" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                    <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                        ...
                        } href="/agent">M-Agent</a>
                        <a className={
                            pathname == "/create-agent" ? "font-medium text-blue-500 hover:text-gray-400" : "text-gray-600 hover:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500"
                        } href="/create-agent">Create Agent</a>
